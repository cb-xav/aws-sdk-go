...
import (
	...
	"github.com/cb-xav/aws-sdk-go/service/kinesis"
	rec "github.com/cb-xav/aws-sdk-go/service/kinesis/records"	
)

// Create a generic kinesis client to use for testing
func createKinesisClient() (*kinesis.Kinesis, error) {
...
func TestSmallLengthReturnsCorrectNumberOfDeaggregatedRecords(t *testing.T) {
	...
	krs = append(krs, kr)
	dars, err = c.DeaggregateRecords(krs)
	if err != nil {
		panic(err)
	}
